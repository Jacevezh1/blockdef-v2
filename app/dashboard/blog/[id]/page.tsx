...
import { getBlogPost, categories } from "@/data/blog";
...
export default async function BlogDetailPage({ params }: BlogDetailPageProps) {
  ...
  const post: BlogPost | undefined = getBlogPost(id);
    ...
    <SidebarProvider>
      ...
      <SidebarInset>
          ...
          <div className="flex items-center gap-2 px-4">
            ...
            <Breadcrumb>
              <BreadcrumbList>
                ...
                <BreadcrumbItem>
                  <BreadcrumbLink href="/dashboard/blog">News</BreadcrumbLink>
                </BreadcrumbItem>
                <BreadcrumbSeparator className="hidden md:block" />
                <BreadcrumbItem>
        ...
        <div className="flex flex-1 flex-col gap-6 p-6 max-w-4xl mx-auto">
          ...
          <div className="prose prose-sm max-w-none dark:prose-invert justify-center">
            <ReactMarkdown
              components={{
                h1: ({ children, ...props }) => (
