        ...
        <div className="flex flex-1 flex-col gap-4 p-4 pt-0">
          ...
          <div className="grid gap-4 md:grid-cols-4">
            <Card>
              ...
              <CardContent>
                <div className="text-md font-bold">$2.3B</div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-md font-bold">1.2M</div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-md font-bold">$450M</div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-md font-bold">3,247</div>
                <p className="text-xs text-muted-foreground">
                  Identified MEV bots
                </p>
              </CardContent>
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    85% reduction in sandwich attacks
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    65% MEV reduction, UX trade-offs
                  </p>
                </div>
              ...
              <CardContent className="space-y-3">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      Advanced bots using ML and game theory for optimal
                      strategies
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      Arbitrage opportunities across different blockchain
                      networks
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      Average user loses $50-200 per sandwich attack
                    </p>
                  </div>
                </div>
